// $ANTLR 3.5.2 com\\af\\dateparser\\generated\\TreeRewrite.g 2022-11-14 13:22:48
		...
		try {
			...
			switch (alt1) {
				case 1 :
					...
					// AST REWRITE
					// elements: SEEK_BY, DAY_OF_WEEK, SEEK, DIRECTION, dow, INT
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 2 :
					...
					// AST REWRITE
					// elements: INT, dow, SEEK_BY, SEEK, DIRECTION, DAY_OF_MONTH
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 3 :
					...
					// AST REWRITE
					// elements: DIRECTION, INT, SEEK, dow, SEEK_BY, MONTH_OF_YEAR
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 4 :
					...
					// AST REWRITE
					// elements: SEEK, amount, DIRECTION, dow, SEEK_BY, MONTH_OF_YEAR
				...
				case 5 :
					...
					// AST REWRITE
					// elements: SEEK_BY, DIRECTION, span, amt, SEEK
				...
				case 6 :
					...
					// AST REWRITE
					// elements: DAY_OF_WEEK, seekby, year, dow, MONTH_OF_YEAR, RELATIVE_DATE, day, YEAR_OF, EXPLICIT_SEEK, SEEK, month, EXPLICIT_SEEK, dir, amount
